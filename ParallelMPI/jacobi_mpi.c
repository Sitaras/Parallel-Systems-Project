...
int main(int argc, char **argv)
{
    ...
    double localTotalError = HUGE_VAL;


    /* Iterate as long as it takes to meet the convergence criterion */
    while (iterationCount < maxIterationCount && localTotalError > maxAcceptableError){
      ...
      localTotalError = sqrt(globalError)/(double)divider;
